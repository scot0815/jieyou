...
public class MailUtil {
    ...
    public MailUtil(boolean debug) {
        ...
        try {
            InputStreamReader in = new InputStreamReader(MailUtil.class.getResourceAsStream("/properties/systemConfig.properties"),"UTF-8");
            properties.load(in);
            this.mailHost = properties.getProperty("mail.smtp.host");
            this.sender_username = properties.getProperty("mail.sender.username");
            this.sender_password = properties.getProperty("mail.sender.password");
            this.sender_foot = properties.getProperty("mail.sender.foot");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void doSendHtmlEmail(String subject, String sendHtml,
        ...
        try {
            ...
            InternetAddress from = new InternetAddress(MimeUtility.encodeWord("解忧杂货店")+" <"+sender_username+">");
